...
export const FORMATS = ["Pitch", "Panel", "Mixer", "Demo Day", "Supper Club", "Workshop", "Showcase", "Breakfast", "Hackathon"];
...
export const SPONSORS_PLATINUM = [
